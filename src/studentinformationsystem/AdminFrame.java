...
public class AdminFrame extends JFrame {
    ...
    static final String PASS = "pb151352";
    String s;
    ...
    AdminFrame() {
        ...
        JLabel per = new JLabel("Percent/CGPA");
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (t1.getText().equals("") || t2.getText().equals("") || t3.getText().equals("")
                    ...
                    try {
                        ...
                        PreparedStatement ps = conn.prepareStatement("INSERT INTO information(form_id,batch_no,student_id,first_name,middle_name,"
